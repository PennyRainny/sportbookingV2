...
export default function LoginPage() {
  ...
  const { login } = useAuth();
  const router = useRouter(); // ✅ แก้จาก useNavigate()
  ...
  const handleLineLogin = () => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      router.push('/home'); // ✅ ใช้ router.push แทน navigate
    }, 1500);
  };
    ...
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            <span className="text-3xl" style={{ color: '#6B8AFF' }}>SPU</span>
          </div>
        </div>
        ...
        <Button
          ...
          disabled={loading}
          className="w-full rounded-xl py-6 transition-all hover:scale-105 shadow-lg flex items-center justify-center gap-2"
          style={{
